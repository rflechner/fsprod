...
let githubLink = "http://github.com/rflechner/fsprod"

// Specify more information about your project
let info =
  [ "project-name", "fsprod"
    "project-author", "rflechner"
    "project-summary", "a small build server based on WebSharper and FAKE"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/fsprod" ]
